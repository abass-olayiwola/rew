...
export default function Dropdown_onMap() {
  return (
    <Menu as="div" className="relative inline-block">
      <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring-1 inset-ring-gray-300 hover:bg-gray-50">
        For Sale
        <ChevronDownIcon aria-hidden="true" className="-mr-1 size-5 text-black-400" />
      </MenuButton>
      ...
      >
        <div className="py-1">
          <MenuItem>
            <a
              href="#"
              className="block px-2 py-2 text-sm text-black-700 data-focus:bg-gray-100 data-focus:text-black-900 data-focus:outline-hidden"
            >
              For Sale
            </a>
          </MenuItem>
